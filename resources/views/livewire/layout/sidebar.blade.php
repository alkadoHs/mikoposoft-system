                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="{{ route('dashboard')}}" class="side-menu__item" wire:navigate>CRM</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('test')}} " class="side-menu__item" wire:navigate>Ecommerce</a>
                                </li>
                                <li class="slide">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="customscrollbar.html" class="side-menu__item">Custom scrollbar</a>
                                </li>
                                <li class="slide">
                                ...
                                <li class="slide">
                                    <a href="ratings.html" class="side-menu__item">Rating</a>
                                </li>
                                <li class="slide">
