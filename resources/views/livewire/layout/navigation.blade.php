...
<nav x-data="{ open: false }" class="sticky top-0 bg-white dark:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-zinc-200 dark:border-zinc-600">
            <div class="px-4">
                <div class="font-medium text-base text-zinc-800 dark:text-zinc-200" x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name" x-on:profile-updated.window="name = $event.detail.name"></div>
